                ...
                <div className="px-2 m-0 Board-view-spacing">
                    <div className="flex App-header-spacing">
                        ...
                        <div className="flex Tab-box-right">
                            ...
                            <div className="App-calendar"><TfiAgenda className="Agenda-icon m-1" size={25}/><span className="App-calendar-text">{date.toLocaleDateString(undefined, options)}</span></div>
                        </div>
                    </div>
                    <div className="">
